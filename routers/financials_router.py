...
@router.post("/financials", summary="Get annual financial statements", tags=["Financials"], operation_id="get_financials")
...
@router.post("/quarterly-financials", summary="Get quarterly financial statements", tags=["Financials"], operation_id="get_quarterly_financials")
...
@router.post("/income-statement", summary="Get annual income statement", tags=["Financials"], operation_id="get_income_stmt")
...
@router.post("/quarterly-income-statement", summary="Get quarterly income statement", tags=["Financials"], operation_id="get_quarterly_income_stmt")
...
@router.post("/balance-sheet", summary="Get annual balance sheet", tags=["Financials"], operation_id="get_balance_sheet")
...
@router.post("/quarterly-balance-sheet", summary="Get quarterly balance sheet", tags=["Financials"], operation_id="get_quarterly_balance_sheet")
...
@router.post("/cash-flow", summary="Get annual cash flow statement", tags=["Financials"], operation_id="get_cash_flow")
...
@router.post("/quarterly-cash-flow", summary="Get quarterly cash flow statement", tags=["Financials"], operation_id="get_quarterly_cash_flow")
