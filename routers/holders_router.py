...
@router.post("/major-holders", summary="Get major holders data for a given symbol", tags=["Holdings"], operation_id="get_major_holders")
...
@router.post("/institutional-holders", summary="Get institutional holders data for a given symbol", tags=["Holdings"], operation_id="get_institutional_holders")
...
@router.post("/mutual-fund-holders", summary="Get mutual fund holders data for a given symbol", tags=["Holdings"], operation_id="get_mutual_fund_holders")
...
@router.post("/insider-roster-holders", summary="Get insider roster holders data for a given symbol", tags=["Holdings"], operation_id="get_insider_roster_holders")
...
@router.post("/insider-transactions", summary="Get insider transactions data for a given symbol", tags=["Holdings"], operation_id="get_insider_transactions")
...
@router.post("/insider-purchases", summary="Get insider purchases data for a given symbol", tags=["Holdings"], operation_id="get_insider_purchases")
