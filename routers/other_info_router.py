...
@router.post("/alt-info", summary="Get alternative general information for a given symbol", tags=["Stock"])
...
@router.post("/earnings-dates", summary="Get upcoming earnings dates for a given symbol", tags=["Stock"])
...
@router.post("/calendar", summary="Get economic calendar events for a given symbol", tags=["Calendar"])
...
@router.post("/sustainability", summary="Get sustainability data for a given symbol", tags=["Analysis"])
...
@router.post("/recommendations", summary="Get analyst recommendations for a given symbol", tags=["Analysis"])
...
@router.post("/recommendations-summary", summary="Get a summary of analyst recommendations for a given symbol", tags=["Analysis"])
...
@router.post("/analyst-price-targets", summary="Get analyst price targets for a given symbol", tags=["Analysis"])
...
@router.post("/revenue-estimate", summary="Get revenue estimates for a given symbol", tags=["Analysis"])
...
@router.post("/earnings-estimate", summary="Get earnings estimates for a given symbol", tags=["Analysis"])
...
@router.post("/growth-estimates", summary="Get growth estimates for a given symbol", tags=["Analysis"])
...
@router.post("/upgrades-downgrades", summary="Get analyst upgrades and downgrades for a given symbol", tags=["Analysis"])
...
@router.post("/isin", summary="Get ISIN (International Securities Identification Number) for a given symbol", tags=["Stock"])
...
@router.post("/capital-gains", summary="Get capital gains data for a given symbol", tags=["Stock"])
...
@router.post("/news", summary="Get news articles for a given symbol", tags=["Stock"])
...
@router.post("/options", summary="Get available option expiration dates for a given symbol", tags=["Stock"])
...
@router.post("/option-chain", summary="Get option chain data for a specific symbol and expiration date. The 'date' parameter should be one of the dates returned by the '/options' endpoint.", tags=["Stock"])
...
@router.post("/shares-full", summary="Get full shares data for a given symbol", tags=["Stock"])
